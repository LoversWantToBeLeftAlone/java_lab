...
ArrayList<TASK> list = connectToMySql.getAllTask(id);
String detail="allTask:";
    ...
    <table width="503" height="190" border="0">
      <tr>
       ...
       <label for="select"></label>
        ...
        <select name="select" size="1" id="select3">
        ...
        <textarea name="textarea" cols="60" rows="15" readonly="readonly" id="textarea"></textarea></td>
      </tr>
      <tr>
